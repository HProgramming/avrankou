...
const Navbar = () => {
    ...
    return (
        <header className="bg-white shadow-md sticky top-0 z-50">
            ...
            <div className="flex h-1 w-full" ref={progressBarRef}>
                <div
                    className="bg-green-500"
                    style={{ width: `${scrollProgress * 33.33}%`, transition: 'width 0.2s', height: '100%' }}
                />
                <div
                    className="bg-yellow-400"
                    style={{
                        width: `${scrollProgress > 0.33 ? Math.min((scrollProgress - 0.33) * 100, 33.33) : 0}%`,
                ...
                <div
                    ...
                    style={{
                        width: `${scrollProgress > 0.66 ? Math.min((scrollProgress - 0.66) * 150, 33.34) : 0}%`,
                        transition: 'width 0.2s',
                        height: '100%',
                    }}
                />
