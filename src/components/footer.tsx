        ...
        <div className="container mx-auto px-4">
            <div className="flex flex-col items-center space-y-6">
                <div className="flex space-x-6">
                    <a
                        href="https://www.facebook.com/avrankou"
                        target="_blank"
                    ...
                    <a
                        href="https://twitter.com/avrankou"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="text-gray-300 hover:text-blue-400 transition-colors duration-200"
                        aria-label="Twitter"
                    ...
                    <a
                        href="https://www.instagram.com/avrankou_officiel"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <a
                        href="https://www.youtube.com/channel/UCavrankou"
                        target="_blank"
                        rel="noopener noreferrer"
                    ...
                    <a
                        href="https://www.linkedin.com/company/commune-avrankou"
                        target="_blank"
                        rel="noopener noreferrer"
